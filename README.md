...
Drop in support 'server.xml' is correct on latest release.  Issues existed in tomcat 8.5 with Jasper listener being present.  Remove that listener to use older builds.
